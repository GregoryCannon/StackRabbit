...
const MEDIUM_PARAM_MODS = {
  ...
  KILLSCREEN: {
    COL_10_PENALTY: 0,
    BUILT_OUT_LEFT_MULTIPLIER: 10.5,
  },
};
const V1_PARAM_MODS = {
  DIG: {
  ...
  KILLSCREEN: { COL_10_PENALTY: 0, BUILT_OUT_LEFT_MULTIPLIER: 10.5 },
};
const V1_5 = {
  DIG: {
    BURN_PENALTY: -1,
...
const V2 = {
  DIG: {
    ...
    BUILT_OUT_LEFT_MULTIPLIER: 1.666666666666667,
  },
  NEAR_KILLSCREEN: {
    BURN_PENALTY: -15,
    TETRIS_READY_BONUS: 10,
...
const V3 = {
  DIG: {
    ...
    BUILT_OUT_LEFT_MULTIPLIER: 0.6664592319119086,
  },
  NEAR_KILLSCREEN: { BURN_PENALTY: -15, TETRIS_READY_BONUS: 10 },
  KILLSCREEN: { COL_10_PENALTY: 0, BUILT_OUT_LEFT_MULTIPLIER: 10.5 },
};
